...
def main() -> None:
    ...
    parser.add_argument("--ablate-relay-calcium-at-stimulus", action="store_true")
    parser.add_argument("--ablate-all-relay-calcium-at-stimulus", action="store_true")
    ...
    mismatch = run_figure7_condition(
        ...
        ablate_relay_calcium_at_stimulus=args.ablate_relay_calcium_at_stimulus,
        ablate_all_relay_calcium_at_stimulus=args.ablate_all_relay_calcium_at_stimulus,

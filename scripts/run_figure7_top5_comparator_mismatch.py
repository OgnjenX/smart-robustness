"""Run the sole fixed top-five comparator mismatch after verified match."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--profile",
        default="configs/calibration/figure7_top5_comparator_mismatch_v1.yaml",
    )
    ...
    sampled = tuple(
        index for index, _ in mismatch.trn_detector_arm_transitions_by_index
    )
    event_counts = {
    ...
    reproduced = assessment.reproduced and fresh_cycles
    artifact = {
        "schema_version": 1,

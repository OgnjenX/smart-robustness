"""Run the preregistered projection-036 Figure 15 weight-direction diagnostic."""
...
def main() -> None:
    ...
    if PROJECTION036_ID in scales:
        raise ValueError("projection 036 unexpectedly differs from source scale")
    ...
    try:
        ...
        for scale in diagnostic["projection036_scales"]:
            arm_scales = dict(scales)
            arm_scales[PROJECTION036_ID] = float(scale)
            ...
            outcomes.append(
                {
                    "projection036_scale": float(scale),
        ...
        yaml.safe_dump(
            {
                ...
                "status": "completed-projection036-weight-direction-diagnostic",
                "classification": registration["classification"],
                "registration": args.registration,
                "runtime_fingerprint": conventions.fingerprint,
                "generation_one_projection_weight_scales": scales,
                "projection036_topology": "variance",

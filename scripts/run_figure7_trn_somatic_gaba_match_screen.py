"""Run the preregistered match-only effective scale screen for TRN GABA 008."""
...
def main() -> None:
    ...
    outcomes = []
    for scale in registration["effective_scale_grid"]:
        ...
        outcomes.append({"effective_scale": float(scale), "match": summary})
        ...
        yaml.safe_dump(
            {
                ...
                "status": "completed-calibrated-match-only-screen",

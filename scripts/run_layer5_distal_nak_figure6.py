"""Run the preregistered Figure 6 control and layer-5 distal Na/K ablation."""
...
def main() -> None:
            ...
            for repetition in range(exact_reruns):
                ...
                output_path.write_text(
                    yaml.safe_dump(
                        {
                            "schema_version": 1,
                            "status": "running-layer5-distal-nak-figure6",
    ...
    ablation_pass = bool(arms["layer5_distal_nak_disabled"]["all_trials_pass"])
    output_path.write_text(
        yaml.safe_dump(
            {
                "schema_version": 1,
                "status": "completed-layer5-distal-nak-figure6",
                "baseline_manifest": args.baseline,
                ...
                "ablation_figure6_pass": ablation_pass,
                "stage_3_authorized": bool(classic_pass and ablation_pass),
                "arms": arms,
            },
            sort_keys=False,
        )

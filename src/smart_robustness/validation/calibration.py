    ...
    *,
    ...
    return replace(
        ...
        nonspecific_calcium_kinetics_convention=(
            None
            if values.get("nonspecific_calcium_kinetics_convention") is None
            else str(values["nonspecific_calcium_kinetics_convention"])
        ),
        ...
        nonspecific_spike_event_threshold_mV=(
            None
        ...
        nonspecific_spike_event_rule=(
            ...
            else str(values["nonspecific_spike_event_rule"])
        ),
        nonspecific_spike_event_proximal_blend_fraction=(
            None
        ...
        trn_soma_potassium_density_mS_cm2=(
            ...
            else float(values["trn_soma_potassium_density_mS_cm2"])
        ),

"""Screen Stage-1 density survivors on the simultaneous Figure 7 match gate."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--stage-1-artifact",
        default="docs/validation-results/figure7-trn-density-cue-grid-170.yaml",
    )
    ...
    for density in densities:
        ...
        print(
            f"{density:g} mS/cm2: relay={len(result.relay_spike_times_ms)} "

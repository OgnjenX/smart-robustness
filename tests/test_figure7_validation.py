...
def test_figure7_result_accepts_relay_pathway_diagnostics() -> None:
    ...
    assert result.trn_layer6ii_ampa_integral_ms_by_index == ()
    assert result.trn_layer6ii_nmda_integral_ms_by_index == ()
    assert result.trn_relay_ampa_integral_ms_by_index == ()

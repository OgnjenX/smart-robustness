"""Run the fixed Figure 7 pair with within-TRN gap junctions removed."""
...
def main() -> None:
    ...
    ablated = tuple(registration["recognition_only_ablation"]["projection_ids"])
    common = dict(
        learned_weights=training.learned_weights,
        conventions=conventions,
        persistent_projection_weight_scales=scales,
        disabled_projection_ids=ablated,
        ...
        yaml.safe_dump(
            {
                ...
                "status": "completed-recognition-only-causal-ablation",
                "classification": registration["classification"],
                "registration": args.registration,
                "runtime_fingerprint": conventions.fingerprint,
                "figure6_gates": figure6_gates,
                "disabled_projection_ids_during_recognition": list(ablated),
                "trn_recurrent_gaba_retained": True,

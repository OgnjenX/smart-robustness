"""Screen the registered TRN density grid at the fixed event offset."""
...
def main() -> None:
    ...
    if not densities or any(
        ...
        raise ValueError("density grid must be finite and remain within bounds")
    ...
    for density in densities:
        ...
        print(
            f"density={density:g} mS/cm2: "
            f"equil_trn={len(result.equilibration_trn_spike_times_ms)} "

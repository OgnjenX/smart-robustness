...
def run_figure15_condition(
    *,
    ...
    top_down_current_mode: str = "sustained_epoch",
    ...
    network_result = run_figure7_condition(
        ...
        persistent_projection_weight_scales=persistent_projection_weight_scales,
        comparator_top_k_targets=comparator_top_k_targets,
        comparator_source_index=comparator_source_index,
        top_down_current_mode=top_down_current_mode,

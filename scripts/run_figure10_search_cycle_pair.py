"""Run the preregistered event-locked Figure 10 search-cycle pair."""
...
def main() -> None:
    ...
    intact = run_figure10_search_cycle_condition(
        reset_pathway_enabled=True, **common
    )
    control = run_figure10_search_cycle_condition(
        ...
        yaml.safe_dump(
            {
                ...
                "status": "completed-figure10-search-cycle-pair",
